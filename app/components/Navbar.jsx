...
const Navbar = ({isDarkMode,setIsDarkMode}) => {
  ...
  return (
    <>
      <div className="fixed top=0 right-0 w-11/12 -z-10 translate-y-[-50%] translate-x-[-80%] dark:hidden">
      ...
      >
        ...
        top-0 bottom-0 w-50 z-50 h-screen bg-rose-50 transi duration-500 dark:bg-darkHover dark:text-white"
        >
